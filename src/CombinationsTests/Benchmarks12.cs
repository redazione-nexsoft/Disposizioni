...
namespace CombinationsTests
{
    ...
    public class Benchmarks12
    {
        ...
        {
			Benchmark("StaticIterations.Combina", () => Combinations.StaticIterations.Combina4_12(new int[] { 1, 2, 3, 4 }, 12));
		}

		[TestMethod]
		public void LinearIterations()
		{
			Benchmark("LinearIterations.Combina", () => Combinations.LinearIterations.Combina(new int[] { 1, 2, 3, 4 }, 12));
		}

		[TestMethod]
		public void RecursiveIterations()
		{
			Benchmark("RecursiveIterations.Combina", () => Combinations.RecursiveIterations.Combina(new int[] { 1, 2, 3, 4 },12));
		}
